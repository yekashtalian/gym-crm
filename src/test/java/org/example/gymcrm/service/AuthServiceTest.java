...
class AuthServiceTest {
  ...
  void authenticate_ShouldReturnFalse_WhenAuthenticationFails() {
    ...
    AuthenticationException mockException = new AuthenticationException("Authentication failed") {};
    ...
    verify(eventPublisher)
        .publishAuthenticationFailure(authenticationToken); // Ensure eventPublisher is called
  }
}
